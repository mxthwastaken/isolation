...
int gui() {
    ...
    ::RegisterClassEx(&wc);
    iso::gui::hwnd = ::CreateWindow(wc.lpszClassName, _T(" "), (WS_POPUP | WS_EX_TOPMOST), 100, 100, 500, 350, nullptr, nullptr, wc.hInstance, nullptr);
    ...
    while (msg.message != WM_QUIT) {
        ...
        ImGui::NewFrame();
        {
            ...
            if (!iso::auth::auth) {
                ...
                draw_list->AddRectFilled(p, ImVec2(p.x + 150, p.y + 350), IM_COL32(30, 30, 30, 255)); //26, 29, 35
                ...
                ImGui::SetCursorPos(ImVec2(472, 4));
                ...
                ImGui::SetCursorPos(ImVec2(480, 7));
                ImGui::Text(("X"));
                ...
                /*-----------------------------------------------------*/
                ImGui::SetCursorPos(ImVec2(10, 316));
                ...
                case 'A': {
                    ...
                    ImGui::BeginChild(("Clicker"), ImVec2(250, 160), true);
                    {
                        ...
                        ImGui::Checkbox(("RMB Lock"), &modules::clicker::rmblock);
                        ...
                        if (!modules::clicker::fcprot) {
                            if (!modules::clicker::mconly) {
                                ImGui::SetCursorPos(ImVec2(120, 124));
                                ImGui::Checkbox(("FC Prot"), &modules::clicker::fcprot);
                            }
                            else {
                ...
                case 'B': {
                    ...
                    ImGui::BeginChild(("GUI"), ImVec2(250, 120), true);
                    {
                        ...
                        ImGui::SetCursorPos(ImVec2(155, 82));
